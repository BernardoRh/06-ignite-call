...
export default function TimeInterval() {
  ...
  async function handleSetTimeSubmit(data: TimeIntervalsFormOutput) {
  ...
  return (
    <>
      ...
      <Container>
        ...
        <IntervalBox as="form" onSubmit={handleSubmit(handleSetTimeSubmit)}>
          <IntervalsContainer>
